...
# ==============================================================================
# TEST DE DÉPARTAGE ET LA VALIDITÉ
# ==============================================================================
...
# Les deux modèles les plus probabables
modele_ARMA11 <- arima(y, order=c(1,0,1))
modele_ARMA21 <- arima(y, order=c(2,0,1))

# On teste  les coefficients 

print("=== COEFFICIENTS ARMA(1,1) ===")
print(round(signif(modele_ARMA11), 3))

print("=== COEFFICIENTS ARMA(2,1) ===")
print(round(signif(modele_ARMA21), 3))

# -Le test de Ljung-Box sur les résidus

print("=== LJUNG-BOX ARMA(1,1) ===")
print(Box.test(modele_ARMA11$residuals, lag=12, type="Ljung-Box", fitdf=2))

print("=== LJUNG-BOX ARMA(2,1) ===")
print(Box.test(modele_ARMA21$residuals, lag=12, type="Ljung-Box", fitdf=3))